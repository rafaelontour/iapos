...
export function DocentesDepartamento({departament}:Props) {
  ...
  const Length =  queryUrl.get('length') || '24';
    ...
    const urlGraduateProgram = `${urlGeral}researcherName?name=&dep_id=${type_search}&lenght=${Length}&page=${Page}`
    ...
    return (
        <div className="px-4 md:px-8">
            ...
            <Alert className="p-0 mb-4 md:mb-8">
                   ...
                   <CardContent>
                     <div className="text-2xl font-bold">{departament.researchers.length}</div>
