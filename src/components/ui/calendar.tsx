...
function Calendar({
  ...
  return (
    ...
    locale={ptBR}
      ...
      classNames={{
        months: "flex flex-col items-center justify-center sm:flex-row space-y-4 sm:space-x-4 sm:space-y-0",
        month: "space-y-4",
        ...
        day: cn(
          ...
          "h-9 w-9 min-w-9 p-0 font-normal aria-selected:opacity-100"
        ),
        day_range_end: "day-range-end",
        day_selected:
          "bg-slate-900 text-slate-50 hover:bg-slate-900 hover:text-slate-50 focus:bg-slate-900 focus:text-slate-50 dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-slate-50 dark:focus:text-slate-900",
        day_today: "bg-eng-blue aspect-square w-10 h-10 text-white dark:bg-eng-blue dark:text-white hover:bg-eng-dark-blue",
        day_outside:
