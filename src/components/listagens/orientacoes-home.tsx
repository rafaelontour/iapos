...
import { GraficoTotalOrientacoes } from "./graficos/grafico-orientacoes-ano"
        ...
        const items = Array.from({ length: 12 }, (_, index) => (
          ...
          const updateDistinct = useCallback(
            ...
            const totalAmong = total.reduce((acc, item) => {
              const sumItem = Object.entries(item).reduce((sum, [key, value]) => {
...
<Accordion  type="single" collapsible defaultValue="item-1">
                ...
                <HeaderResultTypeHome title="Gráfico de quantidade total de orientações" icon={<ChartBar size={24} className="text-gray-400" />}>
                    ...
                    {loading ? (
                      ...
                      <GraficoTotalOrientacoes total={total} />
