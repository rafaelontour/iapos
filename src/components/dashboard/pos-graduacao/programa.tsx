...
import { Blocks, Briefcase, Calendar, ChevronLeft, GraduationCap, Home, LoaderCircle, MapPinIcon, Star, Undo2, Upload, User, Users } from "lucide-react";
...
import { PreviewBuilderPage } from "../builder-page/preview";
              ...
              <div className={`w-full h-full rounded-md ${!(keepoData.app.background_image == "") && ('bg-black/25 ')}  pb-0 md:pb-0 p-4 md:p-8 flex-col flex justify-between `}>
                ...
                >
                            ...
                            {graduatePrograms.researchers.slice(0, 5).map((item, index) => (
                              <Avatar
                                ...
                                onClick={(event) => {
                                  ...
                                  onOpenModal('researcher-modal', { name: item });
                                }}
                  ...
                  <div
                    ...
                    "
                  >
                    <Button variant="outline" size="sm" onClick={() => onOpen('editor-page')} className="h-8 text-eng-blue hover:text-eng-blue">
                      <Gear size={16} /> Configurações
                    </Button>
