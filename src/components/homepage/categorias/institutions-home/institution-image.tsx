...
export const getInstitutionImage = async (institutionId: string): Promise<string | null> => {
  ...
  if (docSnap.exists()) {
    return docSnap.data().img_perfil || null; // Retorna a URL da imagem (img_perfil) ou null se não existir
  } else {
